  ...
  const progress = "step3_andress"
   ...
   try {
    ...
    //   const body = await req.json()
      ...
      return NextResponse.json({token: token, redirectUrl: '/auth/sign-in/step3_storeInformation'}, {status: 200})
        ...
        return NextResponse.json({error: 'Erro ao atualizar dados'}, {status: 400})
      }
