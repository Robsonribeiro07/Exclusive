...
export function CarouselImage() {
    ...
    useEffect(() => {
        ...
        if (isVisible && NextImage.current && !isMouseHover) {
            timer = setInterval(() => {
    ...
    const carouselContent = [
        ...
        { type: "Video", src: "https://www.apple.com/105/media/ww/iphone/family/2024/cf19f185-dd7e-4350-97ff-e44860713b54/anim/welcome-02/xlarge_2x.mp4", id: "video-1" },
        { type: "video", src: "https://www.apple.com/105/media/us/mac/family/2024/b0f6d595-f4dd-4393-8316-102be97a5d1b/anim/welcome/xlarge_2x.mp4", id: "video-1" },
        { type: "image", src: BannerImg },
    ] as const;
