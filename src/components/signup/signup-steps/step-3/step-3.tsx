...
export function StoreInformation() {
    ...
    const STEP3_INPUTS = [
        { name: 'NameStore', placeholder: 'Nome da Loja', type: 'text', register: register('NameStore') },
        { name: 'DescriptionStore', placeholder: 'Descrição da Loja', type: 'textarea', register: register('DescriptionStore') },
        { name: 'Categorias', placeholder: 'Categorias Principais', type: 'select-multiple', register: register('Categorias') },
    ] as const
    return (
