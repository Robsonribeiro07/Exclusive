...
export function Address() {
    ...
    const {
        ...
        isSubmitting, 
        isSubmitSuccessful} = useLocationInformationForm()


    const STEP2_INPUTS = [
        { name: 'zipCode', placeholder: 'CEP', type: 'number', register: register('CEP'),
        ...
        { name: 'country', placeholder: 'País', type: 'text', register: register('Pais'), disabled: !isCepReceivedData },
        
        { name: 'state', placeholder: 'Estado', type: 'text', register: register('Estado'), disabled: !isCepReceivedData },
        { name: 'city', placeholder: 'Cidade', type: 'text', register: register('Cidade'), disabled: !isCepReceivedData },
        { name: 'address', placeholder: 'Endereço', type: 'text', register: register('Endereco'), disabled: !isCepReceivedData },
    ] as const
